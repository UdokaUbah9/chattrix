      ...
      <div className="relative w-full max-w-md  border border-white/10 rounded-[2.5rem] p-8 shadow-2xl animate-in fade-in zoom-in duration-300 bg-yellow-100">
        <form className="space-y-8">
          ...
          <div className="flex gap-4 pt-2">
            <button
              type="button"
              className="flex-1 p-2 rounded-2xl text-red-600 shadow-sm tracking-wider text-xs md:text-sm"
              onClick={onClose}
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isEditing}
              className="flex-1 p-2 rounded-2xl bg-purple-200 text-purple-600 shadow-sm tracking-wider text-xs md:text-sm"
              onClick={onSaveClick}
            >
